...
export class Screen{
    ...
    createCanvas(width, height){
        const elements = document.querySelector(`canvas`);
        const canvas = elements || document.createElement(`canvas`);
    ...
    drawHud(hud){
        this.context.drawImage(this.images[hud.view.imageName],
            hud.view.sourceX, hud.view.sourceY, hud.view.width, hud.view.height,
            hud.view.x, hud.view.y, hud.view.width, hud.view.height);
